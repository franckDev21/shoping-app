            ...
            <div className="pt-3 flex flex-wrap -mx-2 pb-10">
              <div className="w-1/4 px-2">
                <div>
                  ...
                  <ul>
                    <li className="mb-3 text-gray-500"><Link to='/'>About Us</Link></li>
                    <li className="mb-3 text-gray-500"><Link to='/'>Delivery Information</Link></li>
                    <li className="mb-3 text-gray-500"><Link to='/'>Privacy Policy</Link></li>
                    <li className="mb-3 text-gray-500"><Link to='/'>Terms & Conditions</Link></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="w-1/4 px-2">
                <div>
                  ...
                  <ul>
                    <li className="mb-3 text-gray-500"><Link to='/'>My Account</Link></li>
                    <li className="mb-3 text-gray-500"><Link to='/'>Order History</Link></li>
                    <li className="mb-3 text-gray-500"><Link to='/'>Wish List</Link></li>
                    <li className="mb-3 text-gray-500"><Link to='/'>Newsletter</Link></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="w-1/4 px-2">
                <div>
                  ...
                  <ul>
                    <li className="mb-3 text-gray-500"><Link to='/'>Affiliate</Link></li>
                    <li className="mb-3 text-gray-500"><Link to='/'>Special product</Link></li>
                    <li className="mb-3 text-gray-500"><Link to='/'>Manufacture</Link></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="w-1/4 px-2">
                <div>
                  <h2 className="uppercase mb-4 font-semibold">CUSTOMER SERVICE</h2>

                  <ul>
                    <li className="mb-3 text-gray-500"><Link to='/'>Contact Us</Link></li>
                    <li className="mb-3 text-gray-500"><Link to='/'>Returns</Link></li>
                    <li className="mb-3 text-gray-500"><Link to='/'>Site Map</Link></li>
                    <li className="mb-3 text-gray-500"><Link to='/'>Gift Certificates</Link></li>
                  </ul>
                </div>
              </div>
